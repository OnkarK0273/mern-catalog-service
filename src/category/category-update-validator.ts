...
export default [
  ...
  param('id').exists().withMessage('Category ID is required').isMongoId().withMessage('Invalid category ID format'),
  ...
  body('attributes.*.defaultValue').optional().notEmpty().withMessage('Default value is required for attributes'),
